...
{
    name:"Montreal State of Mind",
    type:"NEIPA",
    abv:"7%",
    description:"Our first IPA brewed in the New England east coast style. Tons of citrus.",
    img:"./assets/4Origines/473mLcanmockup_MtlStateofMind_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    name:"Botanik",
    type:"Botanical White",
    abv:"5.5%",
    description:"Botanical White | A beautiful Witbier brewed with gin aromatics stemming from the Cirka Distilleries in Montreal",
    img:"./assets/4Origines/473mLcanmockup_Botanik_Hart_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"Wheat"
},
{
    ...
    type:"Session IPA",
    abv:"4.2%",
    description:"Brewed for hopheads and everyone else. This beer is light in alcohol yet its malt character shines through beautifully.",
    img:"./assets/4Origines/473mLcanmockup_CoteCanal_Hart_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    ...
    type:"Blonde Ale",
    abv:"5%",
    description:"A go to, drinkable ale and good introduction to the world of craft beer. ",
    img:"./assets/4Origines/473mLcanmockup_Ironworks_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"PaleLager/Pilsener"
},
{
    name:"Apocalypse - Joe Beef",
    type:"Natural Ale with Organic Sea Buckthorn from Québec ",
    abv:"4.6%",
    description:"Brewed for the famous Joe Beef restaurant in Little Burgundy, Montreal. This beer is made with organic sea buckthorn berries and tea from Quebec. Its crisp acidity pairs perfectly with seafood dishes.",
    img:"./assets/4Origines/473mLcanmockup_Apocalypse_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"Special"
},
{
    ...
    type:"American IPA",
    abv:"6.5%",
    description:"Hybrid between a classic West Coast IPA with some New England tendencies.",
    img:"./assets/4Origines/473mLcanmockup_Houbombe_Hart_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    ...
    type:"Tea Pale Ale",
    abv:"5.5%",
    description:"A fun twist on a classic style. The tea will lend some bitterness and fruitiness. It's fruity without being sweet reminding you it's still a beer. ",
    img:"./assets/4Origines/473mLcanmockup_Apriknot_Hart_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    name:"Gin Sour",
    type:"Sour w/ Gin Aromatics",
    abv:"5.2%",
    description:"This fresh and sour brew has rich and complex flavours, with a spice profile of cardamom, juniper berries, and lemon confit. It has quickly become a 4 Origins favourite!",
    img:"./assets/4Origines/473mLcanmockup_GinSour_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"Sour"
},
{
    name:"Black Rock",
    type:"Irish Extra Stout",
    abv:"5.7%",
    description:"Discover our all-new Irish Extra Stout, alight and easy to drink stout with notes of dark malts and a roasted finish. With it's beautiful ruby-black colour and rich white head, this is a classic Irish Stout.",
    img:"./assets/4Origines/473mLcanmockup_BlackRockIrish_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"Stout"
},
{
    ...
    type:"Stout",
    abv:"7%",
    description:"Dark and roasty this stout, infused with oak, brings notes of semi-sweet chocolate with hints of biscuit and burnt caramel/toffee. Our « twist » delivers a unique lightly charred finish that makes this perfect for drinking by the fire.",
    img:"./assets/4Origines/473mLcanmockup_BlackisBeautiful_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"Stout"
},
{
    ...
    type:"DDH IPA",
    abv:"7%",
    description:"The second DDH IPA of our Artist Series! With a spotlight on Mosaic hops, we get notes of citrus (tangerine and orange zeste) on the nose, along with hints of stone fruit. A very slight sweetness in the tastes is reminiscent of orange creamsicle, but is well balanced by a clean and bitter finish.",
    img:"./assets/4Origines/473mLcanmockup_SonsofMosaic_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    ...
    type:"DDH IPA",
    abv:"5.5%",
    description:"Brewed in collaboration with Link Up, an organization which connects underrepresented BIPOC communities with opportunities in the Canadian craft brewing industry, this DDH Pale Ale is bursting with sweet tropical and citrus notes, all balanced by the greeness of the hops. It's a beer that's as accessible as we want the industry to be!",
    img:"./assets/4Origines/473mLcanmockup_LinkUp_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    name:"Prochaine Station | 5e Baron",
    type:"Fruited IPA",
    abv:"8%",
    description:"Attention all passengers: next stop, 5e Baron! The first of our new collaboration series, an exploration of hops and fruit, this IPA packs a ton of fruit from the first sip. Passionfruit and guava, as well as notes of mango from the Hydra yeast, this hazy bad boy is refreshing and crisp, with a dry and bitter finish.",
    img:"./assets/4Origines/473mLcanmockup_ProchaineStation5eBaron_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"IPA"
},
{
    ...
    type:"Rice Lager",
    abv:"4.9%",
    description:"| A crushable and crispy lager, brewed in collaboration with Satay Brothers, with a slight residual sweetness from the rice. Ideal paired with Singaporean cuisine.",
    img:"./assets/4Origines/355mLcanmockup_SatayBrothers_230x447.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"PaleLager/Pilsener"
},
{
    ...
    type:"Amber",
    abv:"5.8%",
    description:"Red is back on the table! For lovers of red ales, this amber is a treat! Less sweet than a classic red, this beer still gives you the toasty caramel and toffee flavours, with a dry but lasting finish.",
    img:"./assets/4Origines/473mLcanmockup_InnovationAmber_180x446.webp",
    brewery:"4 Origines",
    breweryId:02,
    filter:"Amber"
},
{
    name:"Hop Water | Passionfruit Tea",
    type:"Hop Water",
    abv:"0%",
